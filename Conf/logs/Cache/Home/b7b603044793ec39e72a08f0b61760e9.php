...
<meta name="keywords" content="微通汇，微信帮手 微信公众账号 微信公众平台 微信公众账号开发 微信二次开发 微信接口开发 微信托管服务 微信营销 微信公众平台接口开发"/>
<meta name="description" content="微通汇，微信公众平台接口开发、托管、营销活动、二次开发"/>
        ...
        <div class="body think-form ">
            <form action="<?php echo U('Users/checkreg');?>" method="post" class="login">
                <table>
                    ...
                    <tr>
                        <th>&nbsp;</th>
                        <td><input class="text" type="hidden" name="invitecode" value="<?php echo $_GET['invitecode'];?>">
...
<div class="foot">
<div class="foot_page">
<a href="/"><?php echo ($f_siteName); ?></a><br/>
